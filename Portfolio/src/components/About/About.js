    ...
    <>
      ...
      <ContactWrapper id="about" className="about section">
        <div className="Container" >
          <div className="SectionTitle" style={{ marginTop: "100px", textAlign: "center", fontSize: "2.8em" , color:"white" }}>
            About Me
          </div>
          <Card className="BigCard" style={{border:"1px solid #854ce6" , color:"white"}}>
            <Image
            ...
            <div className="AboutBio">
              ...
              <li id="user-detail-name">
                Hello! My name is <strong>Madhukar kumar </strong>and I find
